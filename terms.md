# Issue Sponsorship Terms

## <a id="Purpose"></a>Purpose

These terms set out a step-by-step process and ground rules for paid software development to resolve a single development proposal for development of open software, offered to any willing sponsor. These terms cover rules for payment, reporting, and public accountability designed to grow developer and sponsor reputations for honest contracting based on public offers to do paid development work.
...
On receiving the _Down Payment_, _Developer_ agrees to begin work on resolving the _Issue_.
...
When this agreement ends, if _Developer_ ended this agreement [Ending Work](#Ending_Work) or _Sponsor_ ended this agreement under [Reporting](#Reporting), _Developer_ agrees to bill _Sponsor_ for all time spent working on the _Issue_ up to that time, in fairly rounded, quarter-hour increments, at the agreed _Hourly Rate_. _Developer_ will apply the _Down Payment_ against the amount due for time spent.
...
On receiving payment of all undisputed and resolved time charges, _Developer_ agrees to disclose this agreement ended successfully , in the same way they made the _Offer_, within five calendar days. If _Sponsor_ requests that _Developer_ do so by e-mail, _Developer_ agrees to disclose _Sponsor_'s identity. If _Developer_ to disclose _Sponsor_'s identity within that time, _Sponsor_ may do so.

## <a id="Transfer_Fees"></a>Transfer Fees
...
**Lawsuit** means a lawsuit brought by one side against the other, related to this agreement or work on the _Issue_.
